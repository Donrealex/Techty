...
const Review = () => {
  ...
  return (
    <div className="mx-auto px-4 py-8 font-space flex flex-col gap-8 items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
        {comments.map((comment, ) => (
          <div className="cursor-default hover:border-t-2 hover:border-[#28D09A] items-start scale-100 hover:scale-105 transition-transform duration-500 flex flex-col gap-4 p-6 rounded-lg shadow-md hover:shadow-[#28D09A] hover:shadow-sm bg-white"
          >
